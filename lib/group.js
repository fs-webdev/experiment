...
module.exports = function(groups) {
  ...
  /**
   * Returns `true` if this group contains the user with the given `userId` or the sessionId is in the percentage range.
   */
  Group.prototype.contains = function contains(sessionId, userId) {
      if (this.userIds.indexOf(userId) != -1) {
          return true;
      }

      if (typeof this.lowerBound == "number" && typeof this.upperBound == "number") {
          return utils.idInRange(sessionId, this.lowerBound, this.upperBound);
      }
